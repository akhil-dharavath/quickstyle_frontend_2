...
const DeliveryProfile = () => {
    ...
    return (
        <div className="space-y-8 max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Delivery Personnel Profile</h2>
                    ...
                    <div>
                        ...
                        {isEditing ? (
                            <input
                                ...
                                className="w-full mt-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-primary focus:border-primary"
                            />
                        ) : (
